...
Namespace Analysis
    ...
    Public NotInheritable Class AnalysisEnvironment
        ...
        Public Sub RegistExpr(key As U8String, value As IExpression)
            Me._hierarhy.Last().Regist(key, New ExprVariable(value))
        End Sub
        ...
        Public Sub RegistExpr(key As String, value As IExpression)
            Me._hierarhy.Last().Regist(U8String.NewString(key), New ExprVariable(value))
        End Sub
        ...
        Public Sub RegistNumber(key As U8String, value As Double)
            Me._hierarhy.Last().Regist(key, New NumberVariable(value))
        End Sub
        ...
        Public Sub RegistNumber(key As String, value As Double)
            Me._hierarhy.Last().Regist(U8String.NewString(key), New NumberVariable(value))
        End Sub
        ...
        Public Sub RegistStr(key As U8String, value As U8String)
            Me._hierarhy.Last().Regist(key, New StringVariable(value))
        End Sub
        ...
        Public Sub RegistStr(key As U8String, value As String)
            Me._hierarhy.Last().Regist(key, New StringVariable(U8String.NewString(value)))
        End Sub
        ...
        Public Sub RegistStr(key As String, value As U8String)
            Me._hierarhy.Last().Regist(U8String.NewString(key), New StringVariable(value))
        End Sub
        ...
        Public Sub RegistStr(key As String, value As String)
            Me._hierarhy.Last().Regist(U8String.NewString(key), New StringVariable(U8String.NewString(value)))
        End Sub
        ...
        Public Sub RegistBool(key As U8String, value As Boolean)
            Me._hierarhy.Last().Regist(key, New BooleanVariable(value))
        End Sub
        ...
        Public Sub RegistBool(key As String, value As Boolean)
            Me._hierarhy.Last().Regist(U8String.NewString(key), New BooleanVariable(value))
        End Sub
        ...
        Public Sub RegistArray(Of T)(key As U8String, ParamArray value As T())
            ...
            Me._hierarhy.Last().Regist(key, New ArrayVariable(arr))
        End Sub
        ...
        Public Sub RegistObject(key As String, obj As Object)
            Me._hierarhy.Last().Regist(U8String.NewString(key), New ObjectVariable(obj))
        End Sub
        ...
        Public Sub RegistObject(key As U8String, obj As Object)
            Me._hierarhy.Last().Regist(key, New ObjectVariable(obj))
        End Sub
